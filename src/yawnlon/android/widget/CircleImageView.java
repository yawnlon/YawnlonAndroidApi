...
public class CircleImageView extends ImageView {
    ...
    private static final int           DEFAULT_BORDER_ALPHA    = 0;
    ...
    private int                        mBorderAlpha            = DEFAULT_BORDER_ALPHA;
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		mBorderAlpha = a.getInt(R.styleable.CircleImageView_border_alpha, DEFAULT_BORDER_ALPHA);
//
        a.recycle();
